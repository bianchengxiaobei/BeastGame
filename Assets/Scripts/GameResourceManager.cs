...
public class GameResourceManager : MonoBehaviour, IResourceManager
{
    ...
    public IAssetRequest LoadUI(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
    ...
    public IAssetRequest LoadAtlas(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
        if (string.IsNullOrEmpty(url))
        {
            Debug.LogError("string.IsNullOrEmpty(url) == true");
    ...
    public IAssetRequest LoadShader(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
        if (string.IsNullOrEmpty(url))
        {
            Debug.LogError("string.IsNullOrEmpty(url) == true");
    ...
    public IAssetRequest LoadEffect(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
        if (string.IsNullOrEmpty(url))
        {
            Debug.LogError("string.IsNullOrEmpty(url) == true");
    ...
    public IAssetRequest LoadModel(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
        if (string.IsNullOrEmpty(url))
        {
            Debug.LogError("string.IsNullOrEmpty(url) == true");
    ...
    public IAssetRequest CreateAssetRequest(string url, AssetRequestFinishedEventHandler callBackFun, AssetPRI assetPRIType)
    {
        return this.CreateAssetRequest(url, callBackFun, assetPRIType, EnumAssetType.eAssetType_AssetBundlePrefab);
    }
